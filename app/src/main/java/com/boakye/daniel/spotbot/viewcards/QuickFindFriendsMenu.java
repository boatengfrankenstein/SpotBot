...
import com.boakye.daniel.spotbot.components.EditFriendsActivity;
...
public class QuickFindFriendsMenu extends DialogFragment {

    private PagerSlidingTabStrip tabs;
    private ViewPager pager;
    private ContactPagerAdapter adapter;
    public static  String searchNameGottenFromUser;
    EditText friendsFinder ;
    ViewCardMainActivity  g = new ViewCardMainActivity();

    public static QuickFindFriendsMenu newInstance() {
        QuickFindFriendsMenu quickfindFriendsMenu = new QuickFindFriendsMenu();
        return quickfindFriendsMenu;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.friendsquickfragment, container, false);
     ...
     //   tabs.setViewPager(pager);
        ...
        friendsFinder = (EditText) root.findViewById(R.id.quickfragmentEditText);
        Button showFriendsButton  = (Button) root.findViewById(R.id.fab);


        showFriendsButton.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.i("Clicked", "Yea");

                searchNameGottenFromUser =  friendsFinder.getText().toString();
                Log.i("searchName", searchNameGottenFromUser);
                showDialog(v);
                getDialog().dismiss();
